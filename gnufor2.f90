...
!	real(kind=4), intent(in)		:: zrange(2)
...
!***********************************************************************************
	...
	write(file_unit, '(a)') 'set border linewidth 1.5'
	write(file_unit, '(a)') "set style line 1 lc rgb '#0060ad' pt 7 ps 1.0 lt 1 lw 2"
!	write(file_unit, '(a, F9.4, a, F9.4, a)') 'set zrange [', zrange(1), ':', zrange(2), ']'
...
!***********************************************************************************
	...
	write ( file_unit, '(a)' ) 'splot "' // trim ( data_file_name ) // '" w p ls 1'
